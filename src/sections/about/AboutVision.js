...
export default function AboutVision() {
  return (
    <Container component={MotionViewport} sx={{ mt: 10 }}>
      ...
      <Grid container justifyContent="center" style={{background:"#0F3046", paddingBottom:30, paddingTop:30}}>
        <Grid item xs={12} sm={8}>
          <m.div variants={varFade().inUp}>
            <Typography variant="h3" sx={{ textAlign: 'center', color:"white" }}>
              Become an exclusive member of SkyRank link building & content platform and you will get:
            </Typography>
          </m.div>
          <br/>
          <br/>
          <Image
          src="../../../assets/Group647.svg"></Image>
        </Grid>
      </Grid>
    </Container>
  );
